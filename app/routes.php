...
/*=========Item Category Routes============*/
	...
	Route::post('editArticleSave', array(
		'as'	=> 'admin.editArticleSave.post',
		'uses'	=> 'ItemController@saveArticle'
	));
	...
	Route::get('itemArticleEditForm/{itemId}', array(
		'as'	=> 'admin.itemForm',
		'uses'	=> 'ItemController@itemArticleEditForm'
	));

	// End Item Article Edit
...
Route::group(array('prefix' => 'sale', 'before' => 'auth'), function(){
    ...
    Route::get('salesChalan', array(
        'as'	=> 'salesChalan',
        'uses'	=> 'SaleController@salesChalan'
	));
