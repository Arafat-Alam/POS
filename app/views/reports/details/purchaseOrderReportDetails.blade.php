<?	$created = substr($receipt_info->created_at , 0, 10); ?>
	...
	<a href="{{URL::to('purchase/sendOrderToPurchase')}}/{{ $receipt_info->sup_invoice_id }}" class="btn btn-success">Send To Purchase</a>	
	</div>
			...
			<table>
				<tbody>
					<tr style="border-bottom: 1px solid #ccc; width:50%; margin: 3px auto;">
						<td colspan="3" style="text-align:center;"><b>Purchase Order Receipt</b></td>
					</tr>
					<tr>
