        ...
        <div class="account-container">
			...
			{{ Form::open(array('route' => 'admin.login.post')) }}
                <div class="login-wrapper">
                    ...
                    <div class="login-heading" style="margin: 0px auto;">
                        {{ HTML::image('img/memo-logo-ex.png', 'UB Automation', array('class' => 'login-img', 'style' => 'margin: 0px !important;height: 70px; width: 250px;')) }}
                    </div>
                </div>
